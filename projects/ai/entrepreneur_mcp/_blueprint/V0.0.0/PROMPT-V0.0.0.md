...
The `commands/entrepreneur-mcp.md` entry point must implement and enforce the following phases. The orchestrator must assign work to the correct roles in each phase and record the participants.
