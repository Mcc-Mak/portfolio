...
Figure 2 - Delivery timeline (Mermaid timeline)

```mermaid
timeline
    title CMMI Level 4 Pipeline Delivery
    section Foundation
        Core pipeline + W1 order : 2026-01-01
        Requirements skill (R1)  : 2026-01-15
    section Security
        Gates R7-R10             : 2026-02-01
    section CMMI L4
        Metrics C4-2 + SPC C4-3  : 2026-03-01
        Prediction C4-4 + Remediation : 2026-03-15
    section Ops
        Docs matrix (R3)         : 2026-04-01
        Global deploy R14        : 2026-04-15
```
...
| BL-04 | Container/packaging distribution (deb/rpm, sandboxed runtime) | Low | Enhancement |
