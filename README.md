...
| Qualification | Institution | Period | Certificate |
|:--------------|:------------|:-------|:------------|
...
| CompTIA Network+ (N10-009) | CompTIA | 2026 | [PDF](https://mcc-mak.github.io/cv/certificates/CompTIA%20Network+%20CE%20Certificate.pdf) |
...
| Unit | Local · GitHub | Stack | Field · Industry · Role | Year | Description |
|:-----|:------|:------|:------------------------|:----:|:------------|
| docker_laravel | [local](projects/templates/docker_laravel/README.md) · [GitHub](https://github.com/Mcc-Mak/docker-laravel) | `#docker` `#php` `#laravel` `#mysql` | · Field: #web-dev<br/>· Industry: #—<br/>· Role: #developer | in 2024 | Scaffold a Dockerized Laravel boilerplate template |
| dockerized_mern | [local](projects/templates/dockerized_mern/README.md) · [GitHub](https://github.com/Mcc-Mak/dockerized-mern) | `#docker` `#mongodb` `#express` `#react` `#node-js` | · Field: #web-dev<br/>· Industry: #—<br/>· Role: #developer | in 2024 | Scaffold a Dockerized MERN stack boilerplate template |
| secure_web_template | [local](projects/templates/secure_web_template/README.md) · [GitHub](https://github.com/Mcc-Mak/secure-web-template) | `#java` `#spring-boot` `#maven` | · Field: #web-dev<br/>· Industry: #—<br/>· Role: #developer | in 2022 | Scaffold a Spring Boot secure web starter template |
| springboot_mvc_template | [local](projects/templates/springboot_mvc_template/README.md) · [GitHub](https://github.com/Mcc-Mak/springboot-mvc-template) | `#java` `#spring-boot` `#maven` `#jsp` | · Field: #web-dev<br/>· Industry: #—<br/>· Role: #developer | in 2022 | Scaffold a Spring Boot MVC starter template |
